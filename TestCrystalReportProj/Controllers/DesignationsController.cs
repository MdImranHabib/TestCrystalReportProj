...
using TestCrystalReportProj.Data;
using TestCrystalReportProj.Models;

namespace TestCrystalReportProj.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Designation designation)
        {
